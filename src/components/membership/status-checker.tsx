...
export function StatusChecker() {
  ...
  return (
    <div className="space-y-6">
      ...
      {outcome?.kind === "submitted" && <Notice icon={Clock} tone="muted" title="Submitted, awaiting the committee's decision" text={`You submitted this application on ${formatDate(outcome.mine.submittedAt)}${outcome.mine.delivered === "whatsapp" ? " via WhatsApp" : ""}. Decisions appear here once the committee publishes the next registry update.`} />}
