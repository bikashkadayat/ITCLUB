    ...
    variant === "full" ? (
      ...
      <span className={cn("group/logo inline-flex items-center gap-2.5", className)}>
        ...
        <span className="flex flex-col leading-none">
          ...
          <span className="mt-0.5 text-xs lg:text-[11px] tracking-[0.2em] font-semibold uppercase max-[359px]:tracking-[0.08em] lg:text-[9px] lg:tracking-[0.3em] text-brand-red-deep dark:text-brand-coral-light">
            Innovation Club
          </span>
