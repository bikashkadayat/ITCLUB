  ...
  return (
    <section className="section bg-muted/40" aria-labelledby="organogram-heading">
      <div className="container-x">
        <SectionHeading eyebrow="Organogram" align="center" title={<span id="organogram-heading">How the club is organised.</span>} description="The Faculty Advisor oversees the club on behalf of the college. The President leads the Executive Committee; the six departments report through the Vice President and the IT / Technical Coordinator." />
        <Reveal className="mx-auto mt-12 max-w-5xl">
          <ol className="space-y-0" aria-label="Reporting hierarchy">
            <li className="mx-auto max-w-xs"><Node name={by("suman-karki").name} role="Faculty Advisor / Mentor · College oversight" tone="advisor" href="#suman-karki" /></li>
            <Connector />
            ...
            <Connector />
            <li>
              <p className="mb-3 text-center text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Six functional departments · each with a Lead, Assistant Lead and Members</p>
